                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="button--group">
                                                        <button type="button" class="btn btn-sm btn-outline--primary editcustomerbtn" data-toggle="modal" data-target="#exampleModal" data-customer-id="{{ $Customer->id }}" data-customer-name="{{ $Customer->name }}" data-customer-email="{{ $Customer->email }}" data-customer-phone="{{ $Customer->phone }}" data-customer-address="{{ $Customer->address }}">
