                            ...
                            <div class="card-body p-0">
                                <div class="table-responsive--sm table-responsive">
                                    <table class="table--light style--two table">
                                        ...
                                        <tbody>
                                            @foreach($SocialCustomers as $Customer)
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="button--group">
                                                        <button type="button" class="btn btn-sm btn-outline--primary editcustomerbtn" data-toggle="modal" data-target="#exampleModal" data-customer-id="{{ $Customer->id }}" data-customer-name="{{ $Customer->customer_name }}" data-customer-email="{{ $Customer->customer_email }}" data-customer-phone="{{ $Customer->customer_phone }}" data-customer-address="{{ $Customer->address }}">
                                                            <i class="la la-pencil"></i>Edit 
                                                        </button>
                                                
                                                        @if (!$Customer->confirmed)
                                                            <form action="{{ route('social-confirm-customer', $Customer->id) }}" method="POST" style="display:inline-block;">
                                                                @csrf
                                                                <button type="submit" class="btn btn-sm btn-outline--success">
                                                                    <i class="las la-check-circle"></i> Confirm Customer
                                                                </button>
                                                            </form>
                                                        @else
                ...
                <div class="modal fade" id="cuModal">
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <form action="{{ route('social_store-customer') }}" method="POST">
                                @csrf
                                <div class="modal-body">
                                    ...
                                    <div class="form-group">
                                        <label>System Size</label>  <!-- NEW Field -->
                                        <input type="text" class="form-control" name="system_size">
                                    </div>
                                </div>
